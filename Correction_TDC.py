    ...
    traitements = [
        {
            ...
            "dates_a_supprimer": {
                ...
                8253: ['2017-06-21', '2017-05-22', '2016-07-06', '2016-12-13', '2016-07-26', '2017-02-11', '2017-03-03', '2017-05-27', '2016-12-23', '2017-06-01', '2016-05-27', '2017-04-12', '2015-11-29', '2016-10-14'],
                ...
                8259: ['2015-10-20'],
                8263: ['2015-10-20', '2016-04-17'],
                8265: ['2016-04-17', '2017-06-11', '2016-07-26', '2017-06-26', '2016-07-07', '2016-04-07'],
                ...
                8230: ['2016-07-26', '2016-05-27', '2016-08-25', '2017-03-03', '2016-06-26', '2016-10-14'],
        ...
        },
        {
            ...
            "dates_a_supprimer": {
                ...
                8229: ['2018-06-01', '2017-11-18', '2018-05-17', '2018-06-26', '2018-02-01', '2017-09-24', '2017-07-21', '2017-08-15', '2018-06-26', '2017-09-04'],
                ...
                8256: ['2017-08-10'],
                8257: ['2018-06-16', '2017-08-10', '2017-08-15', '2017-07-21', '2017-09-24', '2018-01-02', '2017-11-03', '2018-06-21', '2017-09-04', '2018-06-21', '2017-09-04', '2018-03-28', '2017-11-18', '2017-08-05', '2018-05-17', '2018-06-11'],
                ...
                8265: ['2017-08-25', '2017-08-15', '2017-09-09', '2018-04-02', '2018-06-26'],
                8269: ['2017-11-03'],
                8270: ['2017-11-18'],
        ...
        },
        {
            ...
            "dates_a_supprimer": {
                ...
                8229: ['2019-03-28', '2019-05-02', '2018-07-16', '2018-11-03', '2018-07-11', '2019-05-27', '2018-11-28', '2018-07-11', '2018-07-06'],
                ...
                8265: ['2019-06-21', '2018-08-10', '2018-07-06', '2019-06-21', '2018-07-06', '2018-08-05', '2018-07-31'],
        ...
        },
        {
            ...
            "dates_a_supprimer": {
                ...
                8230: ['2021-06-25', '2020-11-02', '2020-09-08', '2020-09-08', '2021-06-30', '2020-12-22', '2020-08-19'],
                ...
                8265: ['2020-12-12', '2021-04-01'],
                8266: ['2021-03-12', '2021-06-25'],
                8269: ['2020-08-24', '2021-01-01', '2020-10-08'],
                ...
                8276: ['2020-12-07', '2021-02-20', '2021-04-06'],
        ...
        },
        {
            ...
            "dates_a_supprimer": {
                ...
                8253: ['2021-07-20', '2022-05-26', '2022-05-06', '2022-05-21'],
                8254: ['2022-02-15', '2021-10-18', '2021-11-17', '2021-09-28', '2021-09-08', '2022-06-30', '2021-10-28', '2021-11-07'],
                8256: ['2021-07-15'],
                8257: ['2021-07-20', '2022-02-10', '2022-05-26', '2021-09-28', '2022-01-26'],
                8258: ['2022-05-31', '2021-07-15', '2022-05-21'],
                8262: ['2021-12-17'],
                8263: ['2022-05-21', '2021-12-17', '2021-11-12', '2022-05-31', '2021-10-18'],
                8264: ['2022-05-31'],
                8265: ['2021-07-15'],
                8268: ['2021-05-31'],
        ...
        },
        {
            ...
            "dates_a_supprimer": {
                ...
                8241: ['2023-02-25', '2023-05-11', '2022-07-05', '2023-01-01', '2023-06-10'],
                ...
                8275: ['2022-12-17', '2022-09-23', '2022-10-03', '2023-01-01', '2022-10-08', '2023-04-06', '2023-06-30', '2023-09-08'],
        ...
        },
        {
            ...
            "dates_a_supprimer": {
                ...
                8261: ['2023-10-18'],
                8263: ['2024-01-31', '2023-08-24', '2023-12-22', '2023-10-08', '2023-07-30'],
                8264: ['2023-08-24', '2023-10-23'],
                8265: ['2023-07-10', '2024-06-24', '2023-07-30', '2023-08-24', '2024-06-09'],
                8268: ['2023-12-27'],
                8269: ['2024-05-05', '2023-12-17', '2024-02-05', '2024-06-19'],
                8270: ['2023-12-17', '2024-02-05'],
                8274: ['2023-10-08', '2023-10-18', '2024-01-31'],
                ...
                8229: ['2023-07-05', '2024-02-15', '2023-09-08', '2023-08-14', '2024-06-04', '2024-02-15', '2024-01-31', '2024-03-21', '2024-02-05', '2023-08-24', '2023-08-19', '2024-04-25', '2024-05-10', '2024-04-10'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8263: ['2025-01-05', '2024-12-31', '2024-07-24', '2024-11-16', '2025-06-09', '2024-07-24', '2025-06-01', '2025-06-04', '2024-10-17', '2025-03-06', '2025-04-15'],
                8264: ['2025-03-06'],
                ...
                8276: ['2024-12-31', '2024-11-16', '2025-06-04', '2024-08-13', '2024-08-18', '2025-05-20', '2025-03-06', '2025-06-29', '2025-01-30', '2025-01-15'],
                8223: ['2024-10-17', '2025-06-04', '2024-07-19', '2025-03-06'],
                8225: ['2024-07-29'],
                8228: ['2025-04-10', '2024-09-22', '2024-07-24', '2025-02-14', '2025-01-15', '2025-05-12'],
                8229: ['2024-07-09', '2025-02-14', '2025-01-25', '2024-10-17', '2025-04-10', '2025-05-25', '2025-04-15', '2025-05-25', '2025-06-04', '2025-05-30', '2025-04-20', '2025-05-20', '2025-05-12', '2025-06-24', '2024-09-22', '2024-08-13', '2024-07-09'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8227: ['2016-06-06'],
                8233: ['2017-05-12', '2016-12-13', '2016-03-28', '2017-03-03', '2016-04-07', '2016-10-04', '2016-04-17', '2015-11-29', '2016-07-26', '2016-08-25', '2016-06-06', '2016-06-26', '2016-12-13', '2016-07-26'],
                8234: ['2016-06-06'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8280: ['2017-08-25', '2017-09-09', '2017-07-11', '2017-12-23', '2018-08-11', '2017-11-28', '2017-10-09']
            }
        },

        {
            ...
            "dates_a_supprimer": {
                ...
                8204: ['2018-07-16', '2018-10-14'],
                8205: ['2019-06-21', '2018-11-08'],
                8206: ['2018-11-08', '2019-05-02', '2018-08-05', '2018-07-16', '2018-12-18'],
                ...
                8222: ['2018-07-16'],
                8233: ['2018-12-03', '2018-07-16', '2018-07-11', '2019-03-13', '2018-11-03', '2018-08-25', '2018-09-29', '2018-11-08'],
                8234: ['2018-07-16'],
                8280: ['2019-05-12', '2018-10-14', '2019-03-13', '2019-06-21', '2018-12-13', '2018-07-16', '2019-06-11']
            }
        },

        {
            ...
            "dates_a_supprimer": {
                ...
                8196: ['2019-07-11', '2019-11-08'],
                8197: ['2019-07-11', '2019-11-08'],
                8198: ['2019-07-11'],
                8200: ['2020-05-06'],
                8205: ['2019-07-11'],
                8206: ['2019-07-11', '2019-08-10', '2019-07-01', '2019-08-05', '2020-06-15'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8201: ['2022-04-26'],
                8202: ['2022-04-26'],
                8206: ['2022-01-26', '2022-06-30', '2022-02-15', '2021-10-18', '2022-03-12', '2022-04-26', '2022-02-10'],
                ...
                8280: ['2021-08-14', '2021-07-15', '2022-05-21', '2021-09-08', '2022-04-21', '2021-09-28']
            }
        },

        {
            ...
            "dates_a_supprimer": {
                ...
                8200: ['2023-01-01'],
                8202: ['2023-04-21'],
                8204: ['2023-01-01', '2023-04-06', '2023-04-21', '2023-02-10'],
                8205: ['2023-01-01'],
                8206: ['2023-01-01', '2023-03-27', '2023-12-17', '2022-12-17'],
                ...
                8233: ['2022-10-03', '2022-08-24', '2023-03-27', '2022-11-07', '2023-04-06', '2023-05-11', '2023-02-10', '2022-07-05'],
                8280: ['2022-07-05', '2023-05-11', '2022-12-27', '2023-02-10', '2023-06-10', '2023-01-01', '2022-12-07', '2022-10-03', '2022-07-25', '2022-11-27', '2022-10-08', '2023-05-11']
            }
        },
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8205: ['2024-08-18'],
                8206: ['2025-06-01', '2025-06-29', '2025-05-30', '2025-06-09', '2025-04-05', '2025-04-10', '2024-09-22', '2024-08-08', '2024-12-31', '2024-07-19', '2025-03-11'],
                ...
                8233: ['2025-01-05', '2025-06-01', '2025-03-26', '2025-04-20', '2024-12-26', '2026-02-14', '2025-05-12', '2025-01-05', '2025-06-29'],
...

        {
            ...
            "dates_a_supprimer": {
                8224: ['2017-06-21', '2016-05-27', '2017-06-26', '2016-10-14', '2017-06-11', '2016-03-28', '2015-11-29', '2016-03-28', '2015-10-20'],
                8267: ['2017-06-21', '2017-06-21', '2016-06-06', '2016-04-17', '2017-05-22'],
                ...
                8277: ['2016-12-23', '2016-04-17', '2016-06-26', '2017-05-12', '2017-05-12', '2016-07-06', '2017-03-03', '2016-03-28', '2017-02-11', '2017-06-21'],
                8278: ['2017-03-03', '2017-05-12', '2016-12-23', '2015-11-29', '2016-06-26'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8277: ['2018-02-11', '2017-11-28', '2017-10-09', '2017-09-04', '2018-02-11', '2018-02-01', '2018-04-12', '2018-03-13', '2018-01-02', '2017-09-04', '2018-05-17', '2017-07-06', '2017-11-28', '2017-07-21'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8267: ['2019-05-27', '2018-08-05', '2018-07-16', '2018-12-18', '2018-12-13', '2018-07-31', '2018-10-14', '2018-12-08', '2019-06-01', '2018-12-03', '2019-04-27'],
                ...
                8277: ['2018-08-05', '2018-12-13', '2018-12-18', '2018-07-31', '2018-12-03', '2018-10-14', '2018-07-11', '2018-08-30', '2018-11-08', '2018-09-19'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8267: ['2019-09-29', '2020-04-26', '2019-08-15', '2019-12-13', '2019-12-03', '2019-08-15', '2019-07-01'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8267: ['2021-01-06', '2021-04-06', '2020-10-08', '2020-12-22', '2020-08-19', '2021-05-01', '2020-12-12', '2021-06-30', '2021-02-10', '2020-12-22', '2021-03-22'],
                8271: ['2020-12-07', '2021-01-16', '2021-05-01', '2021-03-12', '2021-05-31', '2020-10-08', '2021-05-01'],
                8277: ['2020-12-07', '2020-12-22', '2020-11-02', '2021-01-16', '2021-06-20'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8272: ['2024-03-21'],
                8277: ['2024-05-10', '2024-02-15', '2024-04-10', '2024-05-05', '2024-06-04'],
                8278: ['2024-06-19', '2023-08-14', '2023-10-18', '2024-05-10', '2024-04-05', '2024-02-15'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8277: ['2025-01-15', '2024-08-13', '2025-01-25', '2024-06-19'],
                8278: ['2024-11-16', '2024-08-08', '2025-05-12', '2025-03-26', '2024-07-29', '2024-08-13'],
...

        {
            ...
            "dates_a_supprimer": {
                ...
                8214: ['2021-02-17', '2022-02-15', '2021-11-07'],
